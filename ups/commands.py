...
#                          | commands_engine| log or not      |                             | command   |
	cmd = {              # +----------------+-----------------+-----------------------------+-----------+
		...
		'Delete_job':      {'cmd': run_now, 'history': True,  'bash': 'delete_job.sh',      'url': url, },
		...
		'Maintenance_ON':  {'cmd': runcron, 'history': True,  'bash': 'maintenance_on.sh',  'url': url, },
		'Maintenance_OFF': {'cmd': runcron, 'history': True,  'bash': 'maintenance_off.sh', 'url': url, },
	}
